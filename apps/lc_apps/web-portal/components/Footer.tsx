        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/market" className="text-text-soft hover:text-primary transition-colors text-sm">
                  Donate
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/support/tickets" className="text-text-soft hover:text-primary transition-colors text-sm">
                  Support
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/auth/register" className="text-text-soft hover:text-primary transition-colors text-sm">
                  Register
                </Link>
              </li>
              <li>
                <Link href="/downloads" className="text-text-soft hover:text-primary transition-colors text-sm">
                  Download
                </Link>
              </li>
              <li>
            ...
            <div className="space-y-3">
              <div>
                ...
                <a 
                  ...
                  className="text-primary hover:text-primary-dark hover:drop-shadow-[0_0_10px_rgba(234,209,159,0.5)] transition-all text-sm break-all"
                  target="_blank"
              ...
              <div className="flex space-x-4">
                <a
                  href="https://discord.gg/lastchaos"
                  className="text-text-soft hover:text-primary hover:drop-shadow-[0_0_10px_rgba(234,209,159,0.5)] transition-all"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Discord"
                >
        ...
        <div className="mt-12 pt-8 border-t border-primary/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-4 text-sm justify-center">
              ...
              <Link href="/support/tickets" className="text-text-soft hover:text-primary transition-colors">
                FAQ
              </Link>
