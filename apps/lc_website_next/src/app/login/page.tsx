        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-8 rounded-lg border border-foreground/10 bg-foreground/5">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-foreground/5 text-foreground/60">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              disabled={loading}
              className="px-4 py-3 rounded-lg border border-foreground/10 bg-background hover:bg-foreground/5 transition-colors duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
